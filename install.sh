...
usage() {
  this=$1
  cat <<EOF
$this: download pre-compiled Docker images for TTCECO/rosetta-maro 
...
execute() {
  ...
  docker tag "rosetta-maro:${TAG}" "rosetta-maro:latest"
  log_info "loaded rosetta-maro:${TAG} and tagged as rosetta-maro:latest"
  rm -rf "${tmpdir}"
